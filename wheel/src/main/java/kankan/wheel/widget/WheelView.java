...
public class WheelView extends View {
	...
	/** 顶部和底部项目抵消(隐藏)Top and bottom items offset (to hide that) */
	private static final int ITEM_OFFSET_PERCENT = 10;

	/** Left and right padding value  左和右填充的值    10 */
	private static final int PADDING =0;

	/**默认的可见的物品 Default count of visible items */
	private static final int DEF_VISIBLE_ITEMS = 7;

	// Wheel Values
	private int currentItem = 0;

	// Count of visible items  可见物品的数
