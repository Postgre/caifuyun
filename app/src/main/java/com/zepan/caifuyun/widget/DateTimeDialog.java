...
public class DateTimeDialog extends Dialog implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(isHours){
			...
			minsview.setVisibility(View.VISIBLE);
		}else{
			minsview.setVisibility(View.GONE);
		}
	...
	public void setShow(boolean isHours,boolean isMins){
	...
	public DateTimeDialog(Context context, PriorityListener listener) {
		super(context, theme);
		this.context = context;
	}

	public DateTimeDialog(Context context, String birthDate) {
		super(context, theme);
		this.context = context;
	...
	public void onClick(View v) {
		...
		case R.id.confirm_btn:
			lis.refreshPriorityUI(year_adapter.getValues(),
					...
					hours_adapter==null?"":hours_adapter.getValues(), mins_adapter==null?"":mins_adapter.getValues());
