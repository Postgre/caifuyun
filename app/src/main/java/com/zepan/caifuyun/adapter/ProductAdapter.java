...
public class ProductAdapter extends BaseAdapter{
	...
	public View getView(int position,View convertView, ViewGroup parent) {
		...
		if(convertView==null){
			...
			holder.tv_net_fund=(TextView) convertView.findViewById(R.id.tv_net_fund);
		...
		if(list.get(position)!=null){
			...
			//返佣比例
			holder.proportion.setText(list.get(position).getRebateRatio()+"");
			//基金净值

			holder.tv_net_fund.setText(list.get(position).getNetFund()+"");
