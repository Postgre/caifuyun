...
public class Crop {
	 ...
	 *            Uri for saving the cropped image
	 */
	public static void takeImage(Activity activity, Uri destination) {
		takeImage(activity, destination, REQUEST_TAKE);
	}
	...
	/**
	 * Utility to start an view to take picture with request code
	 * 
	 * @param activity
	 *            Activity that will receive result
	 * @param requestCode
